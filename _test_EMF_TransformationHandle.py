from EMF_TransformationHandle import EMF_Transformation_Handle
...
def testTransformationHandle():
	...
	trns_handle.setTransformation1(EMF_Trns.PrimaryTransformations['FirstOrderDifference'])
	...
	trns_handle.setTransformation2(EMF_Trns.SecondaryTransformations['FirstOrderDifference'])
